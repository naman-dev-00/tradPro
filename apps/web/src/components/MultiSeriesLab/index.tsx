      ...
      <form onSubmit={handleEvaluate} className="bg-slate-900/80 border border-slate-800 rounded-xl p-5 mb-8 shadow-lg space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
          <div>
            ...
            />
            <p className="text-[11px] text-slate-400 mt-1">ISO 8601 UTC timestamp ($t \le eval\_timestamp$ strictly enforced).</p>
          </div>
          ...
          <div className="flex justify-end">
            <button
              ...
              className="w-full sm:w-auto px-6 py-2.5 rounded-lg bg-sky-700 hover:bg-sky-600 disabled:opacity-50 disabled:cursor-not-allowed font-semibold text-sm text-white shadow-md transition-colors focus:outline-none focus:ring-2 focus:ring-sky-400"
            >
