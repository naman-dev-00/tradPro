...
export const ExportButtons: React.FC<ExportButtonsProps> = ({
  ...
  return (
    <div className="p-4 bg-slate-900/60 border border-slate-800 rounded-xl shadow-lg mb-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h4 className="font-semibold text-slate-100 text-sm flex items-center space-x-2">
          ...
          {baselineRunId && (
            <div className="flex space-x-2">
              <button
                ...
                className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 rounded-lg text-xs font-medium flex items-center space-x-1.5 transition-colors focus:outline-none focus:ring-1 focus:ring-sky-500"
              >
